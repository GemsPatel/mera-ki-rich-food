...
jQuery(window).load(function () {
	...
	//setTimeout("jQuery('.preloader_hide, .selector_open').animate({'opacity' : '1'},10)",50);
});
...
jQuery(document).ready(function() {
	...
	jQuery('.menu_block .container').prepend('<a href="javascript:void(0)" class="menu_toggler"><i class="fa fa-align-justify fa-align-ustify"></i></a>');
...
/**
 * Change: On 07-04-2015 to add search button click event by Gautam
 */
jQuery(document).ready(function() 
{
//	jQuery('.top_search_form form').slideUp(1);
...
//	{
//		$('#hide_search').addClass('hide');
//		$('#show_search').removeClass('hide');
//		jQuery('.top_search_form form').slideToggle();
//		jQuery('.top_search_form form').parent().toggleClass('form_active');
//	});
	
//	re-change on 11-18-2016 By Gautam
