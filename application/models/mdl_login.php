...
*/	
	function saveNewAccount()
	{
		...
		*/
		...
		//provide new user video there account panel
		$leftProvideVideo = getField( "config_value" , "configuration", "config_key", "DAILY_WATCH" );
		provideWatchVideo( $customer_id, $leftProvideVideo );
		...
		$subject = 'watch2earn - Welcome to '.baseDomain();
