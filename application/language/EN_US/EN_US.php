<?php
	...
	function getLangMsg( $type, $val='', $is_all=false ) 
	{
		...
		else if( $type === 'Online Video Viewer' )
		{
			return 'Online Video Viewer';
		}
		else if( $type === 'au' )
		{
			return 'About US';
		...
		{
			return '220, silver stone arcade,<br> Singanpore, Kataragam,<br> Surat, Gujarat 395004, <br>India';
		}
		...
		{
			return 'Please enter your email id registered on watch2earn.online. Password email link will be sent on this email id.';
		}
		else if( $type === 'ea' )
		{
		...
		{
			return "Thank you for registering with our Online Video Viewer online jewellery! <br /> Notification to activate your account has been send to your email. If you have any question about the operation of this online diamond jewellery, please";
		}
		else if( $type === 'bttl' )
		{
			return 'BAG TOTALS';
		...
		{
			return 'We hope you will enjoy learning at ';
		}
		else if( $type === 'fb' )
		{
		...
		{
			return "301, Laxminarayan Chamber, Hira Bazar, Mahidharpura, Surat - 395 003, Gujrat";
		}
		else if( $type == "ino" )
		{
			return "Invoice No";
		...
		{
			return "THANK YOU FOR SHOPPING AT watch2earn.online";
		}
		return ""; 
	}
