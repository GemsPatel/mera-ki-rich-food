		...
		<div class="heading"> 
			...
			<div class="buttons">
				...
				<?php if( getSysConfig("IS_ML") ): ?>
					<a class="button" href="<?php echo site_url('admin/'.$this->controller.'/itemLanguages?'.(!empty($get["edit"])?'edit':'insert').'=true&item_id='._en( @$this->cPrimaryId ) );//@$this->cPrimaryId?>">Cancel</a>
				<?php else:?>
					<a class="button" href="<?php echo site_url('admin/'.$this->controller.'/itemLanguages?edit=true&item_id=');?>">Cancel</a>
				<?php endif;?>
			</div>  
		</div>
	</div>
						...
						<table class="form">
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" size="70" name="category_name" value="<?php echo (@$category_name)?$category_name:set_value('category_name');?>" onkeyup="getUrlName(this.value)">
								...
								<tr>
									...
									<td>
										<input type="text" size="70" name="category_alias" id="display_alias" value="<?php echo (@$_POST['category_alias'])? $_POST['category_alias']: @$category_alias; ?>" >
								...
								<tr>
									...
									<td>
										<input type="text" size="70" name="category_meta_name" id="display_alias" value="<?php echo (@$_POST['category_meta_name'])? $_POST['category_meta_name']: @$category_meta_name; ?>" >
								...
								<tr class="hide">
									<td>Brand Code:</td>
									<td>
										<input type="text" name="category_brand_code"  size="35" value="<?php echo (@$category_brand_code)?$category_brand_code:@$_POST['category_brand_code'];?>" style="text-transform:uppercase"  />
									</td>
								</tr>
								<tr>
									<td> Royalty:</td>
									<td>
										<input type="text" size="35" name="category_royalty" value="<?php echo (@$category_royalty)?$category_royalty:set_value('category_royalty');?>">
								...
								<tr>
									...
									<td>
										<textarea id="category_description"  name="category_description"><?php echo (@$category_description)?$category_description:set_value('category_description');?></textarea>
					...
					<table class="form">
						<tbody>
							<tr>
								...
								<td valign="top">
									...
									<span class="small_text">
										<?php $allowedSize = getField("config_value", "configuration", "config_key","PRODUCT_CATEGORIES_IMG_UPLOAD_SIZE");
							...
							<tr>
								<td>Image Size:</td>
								<td>
									<?php $setval =(@$image_size_id)? $image_size_id:@$_POST['image_size_id'];
							...
							<tr>
								...
								<td valign="top">
									<div class="image" style="padding:5px;" align="center">
										<?php $url = (@$category_banner) ? $category_banner : ((@$_POST['category_banner']) ? $_POST['category_banner'] : asset_url('images/admin/no_image.jpg')); ?>
									...
									<span class="small_text">
										<?php $allowedSize = getField("config_value", "configuration", "config_key","PRODUCT_CATEGORIES_BANNER_UPLOAD_SIZE");
							...
							<tr>
								<td>Banner Size:</td>
								<td>
									<?php $setval =(@$banner_size_id)? $banner_size_id:@$_POST['banner_size_id'];
							...
							<tr>
								<td>Sort Order:</td>
								<td>
									<input type="text" size="3" name="category_sort_order" value="<?php echo (@$category_sort_order)?$category_sort_order:@$_POST['category_sort_order'];?>"> 
								</td>
							</tr>
							<tr>
								<td>Status:</td>
