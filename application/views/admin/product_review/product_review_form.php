...
<div id="content">
	...
	<div class="box">
		<div class="heading">
			<h1>
				<img alt="<?php echo $controller; ?>" src="<?php echo getMenuIcon( $this->controller )?>" height="22"> <?php echo pgTitle( $controller );?>
			</h1>
						...
						<table class="form">
							<tbody>
								<tr>
									...
									<td>
										<?php $sql = "SELECT product_id, product_name FROM product";
								...
								<tr>
									...
									<td>
										<textarea id="product_review_description" name="product_review_description"><?php echo (@$product_review_description)?$product_review_description:@$_POST['product_review_description'];?></textarea>
