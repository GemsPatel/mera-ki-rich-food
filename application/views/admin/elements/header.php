...
<meta charset="UTF-8" />
<title><?php echo ( $control ) ? pgTitle( $control ) : 'Admin';?></title>
<base href="<?php echo site_url();?>" />

<link rel="stylesheet" type="text/css" href="<?php echo asset_url('css/admin/stylesheet.css?v=0.1')?>" />
...
<div id="container">
  ...
  <div class="div1">
    <div class="div2">
    	<a id="header_shopname" href="<?php echo site_url('admin')?>">Meraki Rich Foods</a>
        <?php
		...
		?>
    	<div id="notifs_icon_wrapper" class="">
        <?php
        	if($resAdm[0]['admin_user_order_noti_status']==0):
		?>
            <div class="notifs hide" id="orders_notif">
        ...
        <div class="div3">
        	<img src="<?php echo asset_url('images/admin/lock.png')?>" alt="" style="position: relative; top: 3px;" />You are logged in: <span>
            <a rel="modal" href="<?php echo site_url('admin/lgs/accountSettings'); ?>" style="color:#FFF"><?php echo getField("admin_user_firstname","admin_user","admin_user_id",$this->session->userdata('admin_id')); ?></a></span>
        </div>
      </div>
