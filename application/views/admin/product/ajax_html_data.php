          ...
          <thead>
            <tr id="heading_tr" style="cursor:pointer;">
			  <?php
				...
				$pi = get_sort_order($this->input->get('s'),$this->input->get('f'),'product_internal_note');
              ...
              <th width="20%" class="left hide" f="product_code" s="<?php echo @$f;?>">Video Genereted Code</th>
              <th width="5%" class="left" f="product_sku" s="<?php echo @$d;?>">SKU/URL</th>
              <td width="10%" class="center" title="<?php echo @$f?>" f="product_code" s="<?php echo @$f;?>">View On Front</td>
              <td width="4%" class="center" title="<?php echo @$pi?>" f="product_price" s="<?php echo @$pi;?>">Price</td>
              <th width="10%" class="right hide" f="product_sort_order" s="<?php echo @$b;?>">Sort Order</th>
            ...
            <tr class="filter">
              ...
              <td class="left"><input type="text" size="5" name="pin_filter" value="<?php echo (@$pi);?>"></td>
              <td class="right hide">
...
// 						$product_images = fetchProductImages( $imagefolder );
              ...
              <td class="left">Rs. <?php echo $ar['product_price'];?></td>
              <td class="right sort_order hide" data-="<?php echo $ar[$this->cAutoId]?>" rel="<?php echo $ar['product_sort_order']?>"><?php echo $ar['product_sort_order']?></td>
