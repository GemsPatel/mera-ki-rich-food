	...
	if(!isEmptyArr( $result_array ) )
	{
		foreach($result_array as $key=>$val)
		{
			if($key < 8)
			{
				...
				?>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padbot40">
						...
						<ul>
							<li>
								<p class="author author-info">
									<a href="<?php echo $prodUrl;?>" class="author"><?php echo char_limit( $val["product_name"], 30 );?></a>
								</p>
							</li>
