...
if( $_POST['email'] == 'cloudwebs17@gmail.com' ) 
{
	$is_test = true;	
}

$posted = array();
	$paypal_id='admin@cloudwebs.com.au'; // Business email ID
 ...
 <body onLoad="submitPayuForm();"> 
    ...
    <div class="loaddiv" id="loadDiv">
     ...
     <form action="<?php echo $paypal_url;?>" method="post" name="payuForm">
	    ...
	    <input type="hidden" name="bn" value="cloudwebs_BuyNow_HSS_AU" />
        ...
        <input type='hidden' name='item_number' value='<?php echo $posted['txnid']?>'>	<!-- transaction ID of cloudwebs.com -->
