												...
												<tbody>
													<tr>
														<td valign="top" style="line-height:25px;padding:15px;font-style:italic;font-size:16px;width:45%;font-family:Georgia,Times New Roman,Times,serif">
															From:'.$this->session->userdata("customer_emailid").'<br><br>'.$data['customer_note'].'<br><br>'.$inviteFrnd['article_description'].' 
															<a href="'.getCampaignUrl($this->session->userdata("customer_id")).'">Click to join</a><br><br>Regards,<br>'.$cust_id.'
														</td>
