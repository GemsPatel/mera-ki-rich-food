			...
			<div class="modal-body">
				...
				<form method="post" id="forgot" onsubmit="$('#btn_f_password').click(); return false; ">
					<div class="form-group">
						...
						<span class="input-notification error png_bg" for="forgot_email" id="login-error"></span>
						<span class="input-notification error png_bg" for="forgot_not_match" id="login-error"></span>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<input type="submit" value="Submit" name="forgot_password" id="btn_f_password"> 
				<span id="forgot_loading_img" class="hide">
					<img src="<?php echo asset_url('images/preloader.gif') ?>" alt="loader" />
				</span>       
			</div>
		</div>
	</div>
