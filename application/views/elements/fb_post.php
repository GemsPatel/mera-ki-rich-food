...
<input type="hidden" name="url" id="url" value="<?php echo 'http://www.cloudwebs.com/jewellery/diamonds/earrings/the-pernel-drop-earrings/170366';//$url ?>" />
<input type="hidden" name="title" id="title" value="<?php echo 'The Pernel Drop Earrings';//$title ?>" />
<input type="hidden" name="imgUrl" id="imgUrl" value="<?php echo 'http://www.cloudwebs.com/assets/product/PER-225/PEARL/CHI_WAT_PEARL/SIDESTONE1/DIAMOND/DIAMOND-A/YELLOW/PER-225-Y1.jpg';//$imgUrl ?>" />
