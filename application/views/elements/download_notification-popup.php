    		...
    		<form method="post" id="download_app">
	      		...
	      		<div class="modal-body">
        			<div class="download_app">
	            		<a target="_blank" href="https://play.google.com/store/apps/details?id=com.Online Video Viewer.gj_android_3_10&hl=en" >
	                		<img title="Download with android app" src="<?php echo asset_url('images/android-app-icon_download.png')?>" width="200px">
	              		</a>
	              		<a target="_blank" href="https://itunes.apple.com/ao/app/Online Video Viewer/id1030671382?mt=8" >
