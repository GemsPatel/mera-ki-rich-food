...
//Note: refer function Online Video ViewerInitialize in commondb_helper for other constants defined
 ...
 *
 */
define('LOCALHOST_PART', "codeigniter/merakirichfood/" );
...
|--------------------------------------------------------------------------
*/
$_SERVER['HTTP_ORIGIN'] = "http://watch2earn.online";
...
|--------------------------------------------------------------------------
*/
define('BASE_DIR', ( ($_SERVER['HTTP_HOST'] == LOCALHOST_IP) ? $_SERVER['DOCUMENT_ROOT']."/".'codeigniter/merakirichfood/' : $_SERVER['DOCUMENT_ROOT']."/" ) );
...
|--------------------------------------------------------------------------
*/
define( 'ASSET_URL', ( ( $_SERVER['HTTP_HOST'] == LOCALHOST_IP ) ? 'http://'.LOCALHOST_IP.'/codeigniter/merakirichfood/' : 'http://watch2earn.online/' ) );
