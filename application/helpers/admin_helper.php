...
/**
 * @author Cloudwebs
 * @abstract function record any page accessed by user: department_id only applicable when there is department other then cloudwebs
 */
